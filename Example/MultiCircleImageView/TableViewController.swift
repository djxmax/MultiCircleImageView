...
//
//  Created by Maxime Lucquin on 20/10/2015.
...
class TableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let imageList = [UIImage(named: "cell_triangle")!, UIImage(named: "cell_triangle")!]
        
        let circleView = MultiCircleImageView(frame: view.frame)
